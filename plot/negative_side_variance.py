...
def plots(logdir, smooth, save_path, task_name):
    ...
    # results_files = results_dict['results_files']
    # if 'antmaze' in env_groups[0]:
    #     # 2, 3
    # TODO
    ...
    keys = ['critic_total', 'sparse_critic_total']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--logdir', type=str, default='./negative_side_variance')
