...
def plots(logdir, smooth, save_path, task_name):
    ...
    env_groups = ["Hopper-v3", "Walker2d-v3", "Ant-v3"]
    keys = ['normalized_return']
    colors=['#023e8a']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--logdir', type=str, default='./max_performance_gap_0.1_update_ratio_32')
    parser.add_argument('--smooth', type=int, default=0)
    parser.add_argument('--save_path', type=str, default='./plot/')
    parser.add_argument('--task_name', type=str, default='episode_return')
